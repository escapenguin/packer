...
if not defined OPENSSH_URL set OPENSSH_URL=https://deployment/windows/setupssh-6.7p1-2.exe
if not defined SSHD_PASSWORD  set SSHD_PASSWORD=builder-admin
...
"%OPENSSH_PATH%" /S /port=22 /privsep=1
