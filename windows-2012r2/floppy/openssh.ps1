...
# setup openssh
$ssh_download_url = "https://deployment/windows/setupssh-6.8p1-1.exe"
if ($is_64bit) {
...
if (!(Test-Path "C:\Program Files\OpenSSH\bin\ssh.exe")) {
    ...
    Start-Process "C:\Windows\Temp\openssh.exe" "/S /port=22 /privsep=1 /password=builder-admin" -NoNewWindow -Wait
}

Stop-Service "OpenSSHd" -Force

# ensure builder-admin can log in
Write-Host "Setting builder-admin user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\builder-admin\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\builder-admin" /grant "builder-admin:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "builder-admin:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "builder-admin:(OI)RX"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "builder-admin:(OI)(CI)F"
...
Set-Content C:\Users\builder-admin\.ssh\environment $sshenv
